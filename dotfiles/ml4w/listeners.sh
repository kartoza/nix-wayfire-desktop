...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="/etc/xdg/ml4w/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="/etc/xdg/ml4w/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="/etc/xdg/ml4w/listeners/another-listener.sh"
